...
const EmployeeCreation = (props) => {
    ...
    let Add_Employee = (e) => { 
        console.log({applied_list_access:obj.applied_list_access?"true":'false',
        ...
        axios.post(`${port}root/ems/NewEmployeesAdding/`, {...obj,
                                        ...
                                        <div className='row m-0 mt-2'>
                                            ...
                                            <div className="col-md-6 col-lg-4 mb-3">
                                                <div className='flex justify-between'>
                                                    <label htmlFor="gender" className="form-label bg-light">Designation <span class='text-danger'>*</span>
                                                    </label>
