                    ...
                    <Slider {...settings1} className='container ' >
                        <div className=''>
                            <div onClick={() => setHiredCanditates("Internal_Hiring")}
                                data-bs-toggle="modal" data-bs-target="#exampleModal10" className="m-2 box1 cursor-pointer border rounded d-flex justify-content-around align-items-center ">
                                <div><img src={require('../assets/Icon/male-workers-svgrepo-com.png')}
                                    width={50} alt="Icon" />
                                </div>
                                <div>
                                ...
                                <div><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-bar-chart-line" viewBox="0 0 16 16">
                        ...
                        <div className=''>
                            <div className="m-2 box1 border rounded d-flex justify-content-around align-items-center ">
                                ...
                                <div>
                                    ...
                                    <p data-bs-toggle="modal" data-bs-target="#exampleModal10" 
                                    onClick={() => setConsiderToClient("consider_to_client")}>
                                        Consider To Client</p>
                                </div>
                        ...
                        <div className=''>
                            <div className="m-2 box1 border rounded d-flex justify-content-around align-items-center ">
                                ...
                                <div>
                                    <h4 style={{ position: 'relative', top: '5px' }}> {Hiredcounts &&Hiredcounts.AppliedCandidates } </h4>
                                    <p data-bs-toggle="modal" data-bs-target="#exampleModal10" 
