...
const LeaveAllHistory = () => {
    ...
    return (
        <div>
            ...
            <main className='tablebg rounded h-[70vh] p-3 overflow-y-scroll table-responsive '>
                {filteredAllHistory && filteredAllHistory.length > 0 ? <table className='w-full' >
                    <tr>
                        <th>SI No </th>
                        <th>Employee Name </th>
                        <th>Leave Type</th>
                    ...
                    </tr>
                    {
                        filteredAllHistory && [...filteredAllHistory].reverse().map((obj, index) => (
                            ...
                            <tr className='' key={index}>
                                <td>{index + 1} </td>
                                <td className='text-start'>{obj.employee_name} </td>
                                <td>{obj.LeaveType} </td>
